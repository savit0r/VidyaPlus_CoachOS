...
- Code syntax highlighting palette inside docs is not formalized; documentation samples carry type highlighting, but the full highlight scheme is not enumerated
